...
{
    public class GetDepartmentListHandler : IRequestHandler<GetDepartmentListQuery, IEnumerable<EMS.Domain.Entities.Department>>
    {
        private readonly IAsyncRepository<EMS.Domain.Entities.Department> repository;

        public GetDepartmentListHandler(IAsyncRepository<Domain.Entities.Department> repository)
        {
